 ...
 */
/*
 * Name: musicid_lookup_album_text.MusicidLookupAlbumText
 * Description:
...
public class MusicidLookupAlbumText {
	...
	public static void main(String[] args) {
		...
		new MusicidLookupAlbumText().doSample( 
	...
	void doSample( String clientId, String clientIdTag, String licensePath, String libPath, GnLookupMode lookupMode ) {
		...
		try{
			...
			// Perform a sample album text search query
			doSampleAlbumSearch( gnUser );
	...
	//
	void 
	doSampleAlbumSearch( GnUser gnUser ) throws GnException {
		
		System.out.printf("\n*****Sample Album Search*****\n");

		GnMusicId mid = new GnMusicId( gnUser ); // provide status events delegate instead of null to view progress

		mid.options().lookupData( GnLookupData.kLookupDataSonicData, true );
