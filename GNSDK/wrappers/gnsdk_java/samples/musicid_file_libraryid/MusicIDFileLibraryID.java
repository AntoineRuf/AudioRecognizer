 ...
 */
/*
 * Name: musicid_file_libraryid.MusicIDFileLibraryID
 * Description:
...
public class MusicIDFileLibraryID {
	...
	public static void main(String[] args) throws IOException {
		...
		new MusicIDFileLibraryID().doSample( 
	...
	//
	void
	doMusicidFile( GnUser gnUser ) throws GnException {
		...
		// Launch LibraryID
		midf.doLibraryId( GnMusicIdFileResponseType.kResponseAlbums );
