 ...
 */
/*
 * Name: musicid_lookup_album_toc.MusicIDLookupAlbumTOC
 * Description:
...
package musicid_lookup_album_toc;
...
public class MusicIDLookupAlbumTOC {
	...
	public static void main(String[] args) {
		...
		new MusicIDLookupAlbumTOC().doSample( 
	...
	//=============================================================================================
	// performAlbumTOCLookup
	//
	void
	performAlbumTOCLookup( GnUser gnUser ) throws GnException
	{
		System.out.println("\n*****MusicID TOC Query*****\n");

		GnMusicId mid = new GnMusicId( gnUser );
		
		// Perform the query with TOC as input
		GnResponseAlbums albumResponse = mid.findAlbums( "150 14112 25007 41402 54705 69572 87335 98945 112902 131902 144055 157985 176900 189260 203342" );
