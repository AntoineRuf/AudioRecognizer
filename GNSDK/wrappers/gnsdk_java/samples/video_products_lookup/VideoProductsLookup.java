 ...
 */
/*
 * Name: video_products_lookup.VideoProductsLookup
 * Description:
...
public class VideoProductsLookup {
	...
	public static void main(String[] args) {
		...
		new VideoProductsLookup().doSample( 
	...
	//
	void
	doProductLookup( GnUser user ) throws GnException {

		String videoToc = "1:15;2:198 15;3:830 7241 6099 3596 9790 3605 2905 2060 10890 3026 6600 " +
		...
		GnResponseVideoProduct videoResponse = myVideoID.findProducts(videoToc, GnVideoTOCFlag.kTOCFlagDefault);
		...
		while ( productIterator.hasNext() ) {
			...
			System.out.println("Aspect ratio: " + product.aspectRatio());

			System.out.println("Production Type: " + product.videoProductionType());

			System.out.println("Package language: " + product.packageLanguageDisplay());
